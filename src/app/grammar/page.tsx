      ...
      <main className="grammar-main">
        ...
        >
          ...
          <div className="grammar-point">
            ...
            <div className="example-box mt-4">
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  ...
                  <ul className="example-list">
                    ...
                    <li>
                      Phủ định quá khứ: しずかじゃありませんでした - Đã không
                      yên tĩnh.
                    </li>
                  </ul>
                </div>
              ...
              <div className="example-sentence mt-3">
                <h5>
                  <strong>
                    さむい (lạnh - tính từ い) và しずか (yên tĩnh - tính từ
                    な):
                  </strong>
                </h5>
                <p>
            ...
            <table className="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Dùng để tạo thành hai câu đơn, vế sau thường trái ngược với
                    vế trước.
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    Dùng để nối hai câu đơn, vế sau bổ sung hoặc tiếp nối ý
                    nghĩa của vế trước.
                  </td>
                </tr>
                <tr>
          ...
          <div className="grammar-point mt-5">
            ...
            <ul className="example-list">
              <li>
                <strong>Nơi chốn + に + Sự vật/Sự việc + があります:</strong>{" "}
                Tại đâu đó, có cái gì đó.
              ...
              <li>
                <strong>Nơi chốn + で + Sự kiện + があります:</strong> Tại đâu
                đó, có sự kiện gì đó.
                <div className="example">
              ...
              <li>
                ...
                Từ ... đến ... mất bao lâu?
                <div className="example">
                  ホーチミンからハノイまでひこうきでどのくらいですか (Từ HCM đi
                  Hà Nội bằng máy bay mất khoảng bao lâu?).
                </div>
              </li>
              <li>
                <strong>
              ...
              <li>
                ...
                [phương tiện].
                <div className="example">
                  私はコンピューターで日本語をべんきょうします (Tôi học tiếng
                  Nhật bằng máy tính).
                </div>
              </li>
              <li>
              ...
              <li>
                ...
                <div className="example">
                  日本は6月、あめがおおいです (Ở Nhật Bản vào tháng 6, mưa
                  nhiều).
                </div>
              </li>
            </ul>
        ...
        <section id="bai5" className="mb-5 animate__animated fade-in">
          ...
          <div className="grammar-point">
            ...
            <div className="example">
              <ul>
                ...
                <li>
                  わたしは あたらしい かばん が ほしいです。(Tôi muốn có một
                  chiếc cặp mới.)
                </li>
          ...
          <div className="grammar-point">
            ...
            <p>
              Câu hỏi giao tiếp: なにを したいですか。(Bạn muốn làm gì?) /
              どこへ いきたいですか。(Bạn muốn đi đâu?)
            </p>
            <div className="alert alert-info">
              <strong>Lưu ý:</strong>
              <ul>
            ...
            <div className="example">
              <ul>
                ...
                <li>
                  ...
                  <span className="red-text">に</span>
                  <span className="green-text">いきます</span>。(Tôi đi đến
                  trường để học.)
                </li>{" "}
                <li>
                  <u>としょかん</u>
            ...
            <div className="alert alert-info">
              ...
              <ul>
                <li>
                  Nếu trước trợ từ &quot;
                  <span style={{ color: "red" }}>に</span>
                  &quot; là một sự kiện, thì cả câu có thể hiểu là &quot;đi đến
                  A để tham gia/xem sự kiện đó&quot;.
                </li>
                <li>
                  Đối với danh-động từ (động từ có dạng danh từ-します), có thể
                  bỏ ー(を)しに chỉ giữ lại phần danh từ. Ví dụ:
                  <ul>
                    <li>
                    ...
                    <li>
                      <span style={{ color: "red" }}>さんぽ</span>に
                      いきます。(Đi dạo) - Thay vì{" "}
          ...
          <div className="grammar-point">
            ...
            <ul>
              <li>
                <strong>Danh từ + が + すきです / きらいです:</strong> thích/
                ghét cái gì đó (người nào đó)
                <div className="example">
                  <ul>
                    <li>
                    ...
                    <li>
                      わたしはかんたんなひとがきらいです (Tôi ghét người đơn
                      giản)
                    </li>
                  </ul>
                </div>
              ...
              <li>
                ...
                <div className="example">
                  <ul>
                    <li>
                      どうしてあさ、なにもたべませんでしたか (Vì sao buổi sáng
                      anh không ăn gì hết vậy?)
                    </li>
                  </ul>
                </div>
              ...
              <li>
                <strong>Danh từ + と + Động từ-ます:</strong> làm gì đó với ai
                đó
                <div className="example">
                  <ul>
                    <li>
        ...
        <section id="bai6" className="mb-5 animate__animated fade-in">
          ...
          <div className="grammar-point">
            ...
            <ul>
              ...
              <li>
                ...
                <div className="example">
                  えいごはにほんごほどむずかしくないです (Tiếng Anh không khó
                  bằng tiếng Nhật).
                </div>
              </li>
            </ul>
          ...
          <div className="grammar-point">
            ...
            <ul>
              ...
              <li>
                <strong>Ý nghĩa:</strong> Cấu trúc này dùng để diễn đạt rằng
                trong một phạm vi cụ thể, một danh từ là nhất về tính từ nào đó.
                <div className="example">
          ...
          <div className="grammar-point">
            ...
            <ul>
              <li>
                <strong>Cấu trúc:</strong> A と B とどちらが + Adj + ですか
                (Giữa A và B, cái nào hơn?)
                <p className="text-justify">
                  Câu hỏi này dùng khi bạn muốn so sánh hai đối tượng về một đặc
                  điểm nào đó. Bạn hỏi xem đối tượng nào trong số hai đối tượng
                  có tính chất nổi bật hơn.
                </p>
                <div className="example">
              ...
              <li>
                <strong>Cách trả lời:</strong> N のほうが + Adj + です (N thì
                hơn về...)
                <div className="example">
            ...
            <ul>
              <li>
                ...
                (なに/いつ/どこ/だれ) がいちばん + Adj + ですか (Trong tập hợp
                N, cái gì/khi nào/ở đâu/ai là ... nhất?)
              </li>{" "}
              <li>
            ...
            <div className="alert alert-info">
              ...
              xuất hiện của どちら (để hỏi &quot;cái nào&quot;) và dùng A と B
              と để liệt kê hai đối tượng.
            </div>
          </div>
          ...
          <div className="grammar-point">
            ...
            <ul>
              <li>
                ...
                <div className="example">
                  こんばんいっしょにごはんをたべにいきませんか。(Tối nay cùng
                  nhau đi ăn cơm không?)
                  <br />
                  <br />
              ...
              <div className="example">
                コンサートのチケットが2まいあります。(Tôi có 2 chiếc vé
                concert.)
              </div>
              ...
              <li>
                <strong>Danh từ + は + どうですか:</strong> (Đề xuất, đưa ý
                kiến) (Danh từ) thì thế nào?
              </li>
              <div className="example">
              ...
              <li>
                <strong>.... + ね:</strong> (1) Kêu gọi sự đồng tình (2) Xác
                nhận thông tin
              </li>
              <div className="example">
              ...
              <li>
                <strong>.... + よ:</strong> (1) Đưa ra thông tin mới (2) Nhấn
                mạnh ý kiến, tình cảm
              </li>
              <div className="example">
            ...
            <div className="sentence-patterns">
              ...
              <div className="pattern-item mb-4">
                ...
                <p className="pattern-description">
                  [người/ con vật] ở [nơi chốn] (nhấn mạnh vào sự tồn tại của
                  chủ thể là người/ con vật)
                </p>
                <div className="example">
                  <p>
              ...
              <div className="pattern-item mb-4">
                ...
                <p className="pattern-description">
                  Nhấn mạnh vào đối tượng là chủ thể của câu (ở đây là người
                  nào)
                </p>
                <div className="example">
                  <p>
