...
export default function KanjiPage() {
  ...
  const [currentLesson, setCurrentLesson] = useState<number>(6); // Default to lesson 6
  ...
  // Get lesson from URL params or default to 6
  useEffect(() => {
  ...
  const handleLessonChange = (lessonId: number) => {
    ...
    url.searchParams.set("lesson", lessonId.toString());
